package root.example.com.monggopinarak.Cashier;
...
public class CashierDashboard extends AppCompatActivity
    ...
    private final String TAG = "CashierDashboard";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Cashier Dashboard");
            ...
            public void onClick(View v) {
                ...
                if (!email.isEmpty() && !password.isEmpty() && !repassword.isEmpty() && !name.isEmpty()) {
                    ...
                    if (privileges.equals("Select Privileges")) {
                        Toast.makeText(CashierDashboard.this, "Please Select The User Privileges", Toast.LENGTH_SHORT).show();
                        progress.dismiss();
                    } else if (password.equals(repassword)) {
                        createUser(email, password, name, privileges);
                    } else {
                        Toast.makeText(CashierDashboard.this, "Password Doesn't Match", Toast.LENGTH_SHORT).show();
                        progress.dismiss();
                    }
                } else {
                    Toast.makeText(CashierDashboard.this, "Please Fill All Field", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        ...
                        mGetData.setName(ds.child("User").child("Cashier").child(UserIdAdmin).getValue(getData.class).getName());
                        mGetData.setPassword(ds.child("User").child("Cashier").child(UserIdAdmin).getValue(getData.class).getPassword());
                        mGetData.setEmail(ds.child("User").child("Cashier").child(UserIdAdmin).getValue(getData.class).getEmail());
                ...
                if (task.isSuccessful()) {
                    ...
                    switch (privileges) {
                        case "Customer":
                            ...
                            Toast.makeText(CashierDashboard.this, "Success Creating Customer Account", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(CashierDashboard.this, "Unable to Create New User", Toast.LENGTH_SHORT).show();
                    progress.dismiss();
                }
            }
    ...
    private void Relogin() {
        mFirebaseAuth.signInWithEmailAndPassword(EmailAdmin, PasswordAdmin).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                startActivity(new Intent(CashierDashboard.this, CashierDashboard.class));
                finish();
                progress.dismiss();
            }
        }).addOnFailureListener(new OnFailureListener() {
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            backToast.cancel();
            super.onBackPressed();
            Intent intent = new Intent(CashierDashboard.this, MainActivity.class);
    ...
    public void removeFragments(Fragment mFragment) {
        ...
        if (AddTransactionFragmentOpened) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.cashier_dashboard, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            startActivity(new Intent(CashierDashboard.this, MainActivity.class));
            finish();
